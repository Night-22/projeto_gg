...
func _on_body_entered(body: Node2D) -> void:
	...
	if body.has_method("travar_camera"):
		body.travar_camera(area_de_confinamento())
...
func area_de_confinamento() -> Rect2:
	...
	var tamanho_global: Vector2 = tamanho * _colisao.global_scale
	var centro_global: Vector2 = _colisao.global_position

	return Rect2(centro_global - tamanho_global / 2.0, tamanho_global)
